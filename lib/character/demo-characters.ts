...
export const DEMO_CHARACTERS: CharacterSheet[] = [
  ...
  normalizeCharacter({
    ...
    inventory: [
      ...
      { instanceId: "inv-lyanna-4", packId: "magias", entryId: "magias-nova-hex", quantity: 1 },
      ...
      { instanceId: "inv-lyanna-8", packId: "magias", entryId: "magias-muralha-hexagonal", quantity: 1 },
    ],
