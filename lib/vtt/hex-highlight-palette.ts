...
const FALLBACKS: HexHighlightPalette = {
  ...
  walkPaidFill: "rgba(70,130,120,0.62)",
  walkPaidStroke: "rgba(100,180,165,0.85)",
  runFill: "rgba(184,134,11,0.55)",
  runStroke: "rgba(201,169,98,0.65)",
  attackFill: "rgba(180,90,55,0.58)",
  attackStroke: "rgba(180,80,60,0.7)",
  dirFill: "rgba(80,140,200,0.58)",
  dirStroke: "rgba(120,180,255,0.9)",
  areaFill: "rgba(120,60,180,0.6)",
  areaStroke: "rgba(180,120,255,0.85)",
  areaCenterFill: "rgba(200,100,255,0.68)",
  areaCenterStroke: "#e8c4ff",
  invalidFill: "rgba(160,50,50,0.52)",
  invalidStroke: "rgba(220,80,70,0.95)",
  spawnFill: "rgba(90, 115, 82, 0.55)",
  spawnStroke: "rgba(184, 255, 60, 0.9)",
  hoverFill: "rgba(201,169,98,0.28)",
  hoverStroke: "#c9a962",
