...
| 7 | Garras Retrateis | Imune a empurroes involuntarios; pode prender inimigo pequeno (24h). |
| 8 | Figado Alquimico | Qualquer veneno no corpo e queimado para restaurar 1d6 Mana (1/dia). |

## 012 — DRAGAO JOVEM DE GELO

| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Sangue Anticongelante | Imunidade total a dano de frio e penalidades de clima gelado (24h). |
| 2 | Halito de Inverno | Rajada de gelo cone 4m, 3d6 frio; apaga chamas (1/combate). |
| 3 | Baforada Congelante | Alvos atingidos por frio: CD 14 CON ou Paralisado 1 turno (1/combate). |
...
| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Falsa Aparencia | Imovel, indistinguivel de armadura comum (24h). |
| 2 | Formacao de Guarda | +2 CA quando adjacente a outra armadura aliada (24h). |
| 3 | Marcha Silenciosa | Sem som ao se mover em corredores de pedra (24h). |
...
| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Investida | Mover 3m em linha reta antes de atacar: +2d8 contundente no acerto (24h). |
| 2 | Memoria de Labirinto | Impossivel se perder em estruturas fechadas (24h). |
| 3 | Brutalidade Natural | Acerto acima de 20 de dano derruba alvo Prostrado (24h). |
...
| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Mergulho de Rapina | Cair 9m antes de atacar: 4d8 contundente e Agarrado CD 16 FOR (24h). |
...
| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Aderencia de Quitina | Escala paredes e tetos lisos perfeitamente, sem teste (24h). |
| 2 | Glandula Fibrilar | Dispara teias das palmas (alcance 9m); imobiliza ou serve como corda (24h). |
| 3 | Sentido de Teia | Detecta qualquer criatura que toque uma teia sua ou aliada a 30m (24h). |
| 4 | Veneno Paralisante Leve | Mordidas CD 11 CON ou -3m movimento por 1 hora (24h). |
...
| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Constricao | Acerto de mordida: CD 14 FOR ou Agarrado; 2d6/turno (24h). |
...
| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Sentido de Vibracao | Detecta movimento na agua 60m; em terra 10m (24h). |
| 2 | Impulso Sanguinario | Vantagem e +3m movimento contra alvos Sangrando (24h). |
| 3 | Frenesi em Bando | Com 2+ aliados adjacentes ao alvo: +2 em ataques (24h). |
...
| 7 | Ataque Furtivo | +2d6 se tiver Vantagem no ataque (24h). |
| 8 | Coordenacao de Horda | +1 ataque por aliado goblinoide adjacente ao alvo, max +4 (24h). |
...
| 7 | Metabolismo Filtrador | Imune a venenos vegetais nao-magicos (24h). |
| 8 | Camuflagem Vegetal | Vantagem em Furtividade entre flora (24h). |
...
| 8 | Armadura Fina | Cristais sob pele +2 CA (24h). |
...
| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Forma de Gelo | Imune a ataques nao-magicos cortantes (24h). |
| 2 | Sangue Anticongelante | Imune a frio (24h). |
| 3 | Halito de Inverno | Cone 4m 3d6 frio; apaga chamas (1/combate). |
| 4 | Passos de Geada | Corre sobre agua congelada (24h). |
...
| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Sangue Anticongelante | Imunidade total a frio (24h). |
| 2 | Olhar Paralisante | Contato visual CD 13 CON ou Paralisado de medo 1 turno (1/alvo/combate). |
| 3 | Abraco Esmagador | Agarramento automatico; +1d8 frio/turno (24h). |
...
| 8 | Furia de Cabecas | +1 ataque por turno enquanto abaixo de 50% HP (24h). |
...
| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Falsa Aparencia | Imovel, indistinguivel de cristal (24h). |
...
| 7 | Pele Escorregadia | Impossivel ser agarrado (24h). |
| 8 | Voz de Abismo | Vantagem em Performance vocal; eco atravessa pedra 30m (24h). |
...
| # | Habilidade | Efeito |
|---|-----------|--------|
| 1 | Ataque em Mergulho | Cair 6m antes de atacar: dano dobrado (24h). |
| 2 | Grito Ensurdecedor | CD 13 CON ou Ensurdecido 1 min (1/combate). |
| 3 | Asas de Planagem | Planar e queda segura 15m (24h). |
| 4 | Vocalizacao Sonica | Grito CD 13 CON ou Atordoado 1 turno (1/combate). |
| 5 | Plumagem Furtiva | Vantagem em Furtividade (24h). |
| 6 | Garras de Rapina | Ataques corpo a corpo +1d6 (24h). |
| 7 | Visao de Rapina | Sem penalidade tiros longa distancia (24h). |
| 8 | Ossos Ocos | Sem dano quedas 15m (24h). |
...
## INDICE — ASSIMILACAO POR ESPECIME

| Cod | Monstro | Pagina section |
|-----|---------|-------|
...
| 009 | MUMIA | ## 009 |
| 010 | DRAGONETE DE MAGMA | ## 010 |
| 011 | WYVERN | ## 011 |
| 012 | DRAGAO JOVEM DE GELO | ## 012 |
| 013 | DRAKE DE PEDRA | ## 013 |
| 014 | DRAGAO ANCIAO DE FOGO | ## 014 |
| 015 | GOLEM DE PEDRA | ## 015 |
| 016 | ARMADURA ANIMADA | ## 016 |
| 017 | GOLEM DE FERRO VULCANICO | ## 017 |
| 018 | AUTOMATO DE GENIO | ## 018 |
| 019 | MINOTAURO | ## 019 |
| 020 | BASILISCO | ## 020 |
| 021 | MANTICORA | ## 021 |
| 022 | GRIFO | ## 022 |
| 023 | COCATRIZ | ## 023 |
| 024 | ARANHA TECERROCHAS | ## 024 |
| 025 | ESCORPIAO GIGANTE | ## 025 |
| 026 | CENTOPEIA CAUSTICA | ## 026 |
| 027 | BESOURO-DIAMANTE | ## 027 |
| 028 | SAPO-ENGOLIDOR | ## 028 |
| 029 | KRAKEN MENOR | ## 029 |
| 030 | SERPENTE-DO-ABISMO | ## 030 |
| 031 | TUBARAO-CEGO | ## 031 |
| 032 | GOBLIN DE CAVERNA | ## 032 |
| 033 | HOBGOBLIN GUERREIRO | ## 033 |
| 034 | ORC DE MASMORRA | ## 034 |
| 035 | COGUMELO-REI | ## 035 |
| 036 | TREANT PODRE | ## 036 |
| 037 | PLANTA CARNIVORA GIGANTE | ## 037 |
| 038 | SLIME ACIDO | ## 038 |
| 039 | SLIME DE CRISTAL | ## 039 |
| 040 | ELEMENTAL DE FOGO | ## 040 |
| 041 | ELEMENTAL DE GELO | ## 041 |
| 042 | YETI | ## 042 |
...
| 047 | QUIMERA | ## 047 |
| 048 | ANJO CAIDO | ## 048 |
| 049 | GARGULA DE CRISTAL | ## 049 |
| 050 | ABERRACAO TENTACULAR | ## 050 |
| 051 | BASILISCO DE MAGMA | ## 051 |
| 052 | SEREIA DAS PROFUNDEZAS | ## 052 |
| 053 | TROLL DE PEDRA | ## 053 |
| 054 | CICLOPE | ## 054 |
| 055 | HARPIA DE CAVERNA | ## 055 |
| 056 | ROPER | ## 056 |
| 057 | ABOLETH | ## 057 |
| 058 | PUDIM NEGRO | ## 058 |
| 059 | LAGOSTA-GIGANTE ABISSAL | ## 059 |
| 060 | CARANGUEJO-EREMITA COLOSSAL | ## 060 |
