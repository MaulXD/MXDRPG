...
import { listActiveInventoryRequestsForUser } from "@/lib/character/inventory-item-request-store";
...
export async function GET(_req: Request, { params }: Params) {
  ...
  const requests = await listActiveInventoryRequestsForUser(adventureId, session.user.id);
