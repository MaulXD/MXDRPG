...
export function Battlefield({
  ...
  const { spawnDragActive, spawnDropHandlers } = useMonsterSpawnDrop({
    ...
    scene: displayScene,
    roomId,
    enabled: battlefieldGm && rpgSystemId !== "um-anel",
    allowActorDrop: canEdit && rpgSystemId !== "um-anel",
    allowTorCharacterDrop: canEdit && rpgSystemId === "um-anel",
    allowTorAdversaryDrop: battlefieldGm && rpgSystemId === "um-anel",
    onSpawned: syncRoom,
    setHoverAxial,
    onHoverAxialChange,
