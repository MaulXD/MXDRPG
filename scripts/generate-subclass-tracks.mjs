...
const raw = [
  ...
  ["Clérigo", "Clérigo Contemplativo", "Energia Interna", "Jejum de masmorra 8h+: +4 esquiva e dano radiante", 4, "Disciplina Vazia", 8, "Golpe do Jejum", 12, "Jejum Prolongado", 16, "Corpo Templo", 20, "Transfiguração pelo Vazio"],
  ...
  ["Feiticeiro", "Linhagem Bestial", "Predadores e Feras", "Assimilação de fera: instinto de caça e +1d4 em magias ofensivas por 8h", 4, "Presa Marcada", 8, "Uivo Interior", 12, "Corpo do Predador", 16, "Alfa Inato", 20, "Forma da Besta Primordial"],
  ["Feiticeiro", "Sangue Selvagem", "Mutação Incontrolável", "Assimilação selvagem: após magia, rola mutação menor 1×/combate", 4, "Torrente Caótica", 8, "Onda Instável", 12, "Tempestade Interna", 16, "Cataclismo Inato", 20, "Fúria Primordial"],
  ["Feiticeiro", "Eco Abissal", "Pressão e Sombra", "Assimilação abissal: imune medo, +1 CD magias de controle", 4, "Voz do Vácuo", 8, "Manto de Profundezas", 12, "Corrente Mental", 16, "Fissura Abissal", 20, "Boca do Abismo"],
  ["Feiticeiro", "Chama Inata", "Calor Vital", "Assimilação ígnea: truques de fogo +1d4 por 8h", 4, "Centelha Persistente", 8, "Brasas Internas", 12, "Forno Interior", 16, "Combustão Súbita", 20, "Coração Incandescente"],
  ["Espiritualista", "Punho do Limiar", "Impacto e Precisão", "Assimilação de predadores: +2 esquiva e +1d6 em golpes desarmados por 8h", 4, "Golpe do Vácuo", 8, "Punho Cortante", 12, "Tempestade de Punhos", 16, "Quebra de Ossos", 20, "Punho do Colosso"],
  ["Espiritualista", "Tecelão do Vácuo", "Fluxo e Distância", "Assimilação etérea: passos não provocam ataques 1×/turno", 4, "Passo do Vácuo", 8, "Rede de Chi", 12, "Silêncio Interior", 16, "Ruptura Dimensional", 20, "Mente no Limiar"],
  ["Espiritualista", "Asceta da Dor", "Carne e Sangue", "Assimilação brutal: pode gastar PV para ganhar Chi extra no combate (até 2)", 4, "Ferida Aberta", 8, "Autoflagelo", 12, "Ritual de Sangue", 16, "Corpo Rasgado", 20, "Martírio"],
  ["Espiritualista", "Guardião da Respiração", "Defesa e Sustento", "Assimilação serena: +2 CON e recupera 1 Chi extra após descanso curto", 4, "Muro de Chi", 8, "Respiração de Ferro", 12, "Campo Protetor", 16, "Pele de Vento", 20, "Templo Vivo"],
