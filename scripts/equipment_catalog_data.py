...
BESTAS = [
    ("BST-01", "Besta Leve", "1d8", 6),
    ("BST-02", "Besta de Mão", "1d6", 3),
    ("BST-03", "Besta Pesada", "1d10", 5),
    ("BST-04", "Besta de Repetição", "1d8", 5),
    ("BST-05", "Besta de Assalto", "1d10", 4),
    ("BST-06", "Besta de Caverna", "1d8", 4),
    ("BST-07", "Besta de Alcance", "1d10", 7),
    ("BST-08", "Besta de Engenharia", "1d10", 6),
]
