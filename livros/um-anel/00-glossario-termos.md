# Glossário de termos — O Um Anel (2ª edição) em PT-BR

> Termos-chave traduzidos do zero pra esta implementação (não reaproveita a
> terminologia dos livros "Tales from Wilderland"/"Darkening of Mirkwood"
> traduzidos por Mateus Soares — aqueles são da 1ª edição/Cubicle 7, um
> sistema mecanicamente diferente da 2ª edição/Free League que estamos
> implementando aqui).
>
...
| Shadow Weakness / Flaw | Fraqueza / Falha da Sombra |
...
| Inglês | PT-BR |
|---|---|
| Feat Die | Dado de Proeza |
| Success Dice | Dados de Sucesso |
| Target Number (TN) | Número-Alvo (NA) |
| Degree of Success | Grau de Sucesso |
...
| Fellowship Rating | Nível de Companhia |
| Fellowship Focus | Foco da Companhia |
| Adventuring Phase | Fase de Aventura |
| Fellowship Phase | Fase de Companhia |
| Undertaking | Empreitada |
| Journey | Jornada |
| Guide | Guia |
| Scout | Batedor |
| Hunter | Caçador |
| Look-out | Vigia |
| Marching Test | Teste de Marcha |

## Regiões / Culturas (nomes próprios — manter reconhecíveis)
