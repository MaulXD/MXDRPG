...
## Pressao ambiental (geral)

| Severidade | Sem protecao | Com 1 via | Com 2+ vias |
|------------|--------------|-----------|-------------|
...
**Forrageiro:** em bioma listado na ficha da planta, encontrar flora relevante com **1d6** — 1-3 planta certa, 4-5 planta adjacente (efeito metade), 6 nada (predador ou vazio).

---

## Composicao de cenario (camadas)

Ao montar um mapa, empilhe **1 de cada camada** + **1-3 props** + **0-1 perigo passivo**:

1. **Chao** — terreno que define movimento (lama, gelo, teia, agua).  
2. **Meio** — obstaculos de altura (estante, coral, piston).  
...
| Resistir frio | 5 | 09, 17, 31 | 042, 043 | B05-01, G09 |
| Orientacao | 1, 6, 9 | 01, 10, 24 | 024, 045 | B01-04, B06-05 |
| Anti-toxina/gas | 3, 10, 20 | 06, 16, 05 | 038, 058 | B03-04, B10-02 |
