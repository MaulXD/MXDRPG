...
Estômago Botânico (goblins fúngicos), Cemitério de Colossos, Engrenagens, Floresta de Fios de Prata, Pântano.
...
## Assimilação — Goblinóides e Necrofagos
...
| 5 | Garras de Escavador | Escava terra/cascalho em velocidade de caminhada |
| 6 | Metabolismo Acelerado | Descanso curto/longo metade do tempo |
| 7 | Visão de Submundo | Visão no escuro absoluto |
| 8 | Aderência Rasteira | Velocidade máxima rastejando/deitado |

---

## Cozinha

- **Transmutação de Carne** (magia nv. 2) converte goblin → “equivalente” grifo (mesma raridade) — útil moralmente ambíguo.  
- Caldos de horda: buff social +2 Intimidação (Mestre).

**Espécimes:** Goblin, hobgoblin, orc, ghoul — bestiário Cap. VII.

---

## Gancho

Tribo goblin fúngica oferece **mapa do andar** em troca de não cozinhar o xamã morto.
